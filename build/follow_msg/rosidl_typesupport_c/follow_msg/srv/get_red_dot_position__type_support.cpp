...
#include "follow_msg/srv/detail/get_red_dot_position__type_support.h"
...
static const _GetRedDotPosition_Request_type_support_symbol_names_t _GetRedDotPosition_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, follow_msg, srv, GetRedDotPosition_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, follow_msg, srv, GetRedDotPosition_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, follow_msg, srv, GetRedDotPosition_Request)() {
  return &::follow_msg::srv::rosidl_typesupport_c::GetRedDotPosition_Request_message_type_support_handle;
}
...
static const _GetRedDotPosition_Response_type_support_symbol_names_t _GetRedDotPosition_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, follow_msg, srv, GetRedDotPosition_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, follow_msg, srv, GetRedDotPosition_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, follow_msg, srv, GetRedDotPosition_Response)() {
  return &::follow_msg::srv::rosidl_typesupport_c::GetRedDotPosition_Response_message_type_support_handle;
}
...
static const _GetRedDotPosition_type_support_symbol_names_t _GetRedDotPosition_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, follow_msg, srv, GetRedDotPosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, follow_msg, srv, GetRedDotPosition)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, follow_msg, srv, GetRedDotPosition)() {
  return &::follow_msg::srv::rosidl_typesupport_c::GetRedDotPosition_service_type_support_handle;
}
